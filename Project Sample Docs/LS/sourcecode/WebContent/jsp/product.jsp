								...
								<s:iterator value="product">
									<tr>
										...
										<table class="c4" border="2" cellpadding="2" cellspacing="2">
											<tbody>
												<tr>
													<td class="c50"><s:if test="%{product.cost > 0}">
														<s:property value="product.name" />
													</s:if> <s:else>
														<a
															href="<s:url action="getItems">
                                    <s:param name="id" value="product.id"/></s:url>">
                                    ...
                                    <s:param name="id" value="product.id"/></s:url>">
														<img class="c3" alt="" border="0"
															src="images/addToCart.gif" /> </a>
													</s:if> <s:else>
														<s:property value="itemCount" /> items on display!
                                  </s:else></td>
												</tr>
											</tbody>
										</table>
										...
										<td><s:iterator value="images.images">
											<s:if test="%{product.cost > 0}">
												<img border="0" alt="" src="<s:property value="top.path"/>" />
											</s:if>
											<s:else>
												<a
													href="<s:url action="getItems">
